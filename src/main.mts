...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "1": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/4Zf4doH54RDit9KVsfCp3MkjrP3szhJZwvw2z5PHczx9",
  },
  // X Layer subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "196": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/NRh6ScvPKoieeSH7tRiKyXJ97DR9aYraas8eREPQ8e3",
  },
  // ZKsync Era subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "324": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/3CHaJvCkTMqXa4PRKNshVecE9JqgNFCdsXNyGLZXFeM2",
  },
  // Linea subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "59144": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/DLzwo1WFaKy7R7MgQWrnBXr19EbGwPRubu9YmsSmRMfC",
  },
  // Blast subgraph, by subgraphs.messari.eth (0x7e8f317a45d67e27e095436d2e0d47171e7c769f)
  "81457": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/6JP9542ArawumBSYczerbWGu6k7uu3hqk6qJnSkrgTM5",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validTokens.map((token) => {
    ...
    return {
      ...
      "UI/Website Link": "https://zerolend.xyz/",
      "Public Note": `ZeroLend's official ${token.name} token contract.`,
    };
  });
}
